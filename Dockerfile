...
RUN wget --no-check-certificate --quiet $SCHEMA_URL -O /docker-entrypoint-initdb.d/00_load_chado.sql.disabled.gz && gunzip /docker-entrypoint-initdb.d/00_load_chado.sql.disabled.gz
